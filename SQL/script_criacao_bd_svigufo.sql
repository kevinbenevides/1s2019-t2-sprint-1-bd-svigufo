/*DOCUMENTAÇÃO https://docs.microsoft.com/pt-br/sql/t-sql/data-types/data-types-transact-sql?view=sql-server-2017 */
...
--IDENTITY - AUTO INCREMENTA O VALOR PARA CADA REGISTRO
-- PRIMARY KEY - DEFINE QUE O CAMPO É CHAVE PRIMÁRIA
-- UNIQUE - REGISTROS UNICOS, NÃO DEIXA INSERIR UM DADO IGUAL
...
CREATE TABLE EVENTOS (
	...
	,ID_INSTITUICAO INT
	,ID_TIPO_EVENTO INT
	-- DEFINE AS CHAVES ESTRANGEIRAS, REFENECIA A TABELA
